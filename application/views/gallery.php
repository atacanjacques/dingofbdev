                    ...
                    <ul class="hide-bullets">
                       ...
                       foreach($liste_participation as $participation)
                       {
                        ...
                        <li class="col-sm-4 col-xs-12">
                            ...
                            data-action="<?php echo $vote_action; ?>" data-signalement="/vote/add_signalement/<?php echo $participation->id; ?>"  data-id="<?php echo $participation->id; ?>" rel="group" href="<?php echo $participation->source_photo; ?>" id="carousel-selector-3">
                            ...
                            <script>
                              $(document).ready(function(){
                                $('body').on('click', '.share-<?php echo $participation->id; ?>', function(e){
                                  e.preventDefault;
                                  FB.ui({
                                    method: 'feed',
