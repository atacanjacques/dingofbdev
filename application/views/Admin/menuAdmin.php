                    ...
                    <ul class="nav_admin">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="subnav1">
                                ...
                                <li class="subnav-item">
                                    <a class="button_type" href="<?php echo site_url('Admin/listConcours') ?>">Modifier
                                        un concours</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="subnav">
                                <li class="subnav-item">
                                    <a class="button_type" href="<?php echo site_url('Admin/imgReport/') ?>">Images</a>
                                </li>
                                <li class="subnav-item">
                                    <a class="button_type" href="<?php echo site_url('Admin/listUsers') ?>">Utilisateurs</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="button_type" href="<?php echo site_url('Admin/administration/') ?>">Administration</a>
                        </li>
                        <li class="nav-item">
